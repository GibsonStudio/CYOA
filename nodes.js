...
node.addText("You struggle to see and trip on a toy. You fall down and bash your head. Lose 10 health.", { condition:"!player.hasItem('torch')", action:"player.injure(10)" });
